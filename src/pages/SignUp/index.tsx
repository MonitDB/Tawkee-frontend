...
export default function SignUp(props: { disableCustomTheme?: boolean }) {
  ...
  const validateInputs = () => {
    ...
    if (!workspaceName.value || workspaceName.value.length < 1) {
      setWorkspaceNameError(true);
      setWorkspaceNameErrorMessage('workspaceName is required.');
      isValid = false;
    } else {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (nameError || emailError || passwordError || workspaceNameError) {
      return;
    }
          ...
          >
            ...
            <FormControl>
              ...
              <TextField
                ...
                error={nameError}
                helperText={workspaceNameErrorMessage}
                color={nameError ? 'error' : 'primary'}
              />
            </FormControl>
            <Button
